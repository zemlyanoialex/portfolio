...
export const CLIENTS = [
  {
    name: "Pure Charity",
    slug: "pure-charity",
    website: "https://purecharity.com/",
    logo: {
      path: "client/pure-chartiry.webp",
      alt: "Pure Charity logo",
    },
    relationship: {
      from: null,
      to: null,
    ...
    summary: null,
    projectSlugs: ["pure-charity-plugin"],
    order: 1,
    isFeatured: false,
    isHidden: false,
    isArchived: false,
  },
  {
    name: "Km Ware US LLC",
    slug: "km-ware-us-llc",
    website: "http://www.km-ware.com/",
    logo: {
      path: "client/km-ware.webp",
      alt: "Km Ware US LLC logo",
    },
    relationship: {
      from: null,
      to: null,
  ...
  },
  {
    name: "Digiproduct",
    slug: "digiproduct",
    website: "http://digiproduct.co.il",
    logo: {
      path: "client/digiproduct.svg",
      alt: "Digiproduct logo",
    },
    relationship: {
      from: null,
      to: null,
  ...
  {
    name: "Viennaresidence",
    slug: "viennaresidence",
    website: "https://www.viennaresidence.com/",
    logo: {
      path: "client/vienna.svg",
      alt: "Viennaresidence logo",
    },
    relationship: {
      from: null,
      to: null,
  ...
  },
  {
    name: "ECM Solutions",
    slug: "ecm-solutions",
    website: "http://ecmsolutions.ca/",
    logo: {
      path: "client/ecm-solutions.svg",
      alt: "ECM Solutions logo",
    },
    relationship: {
      from: null,
      to: null,
  ...
  },
  {
    name: "SoundSuite",
    slug: "soundsuite",
    website: "https://soundsuit.fm/",
    logo: {
      path: "client/soundsuite.svg",
      alt: "SoundSuite logo",
    },
    relationship: {
      from: null,
  ...
  },
  {
    name: "SuperCake",
    slug: "supercake",
    website: "https://supercake.co/",
    logo: {
      path: "client/supercake.png",
      alt: "SuperCake logo",
    },
    relationship: {
      from: null,
  ...
  },
  {
    name: "SoundAlerts",
    slug: "soundalerts",
    website: "https://soundalerts.com/",
    logo: {
      path: "client/soundalerts.svg",
      alt: "SoundAlerts logo",
    },
    relationship: {
      from: null,
      to: null,
  ...
  },
  {
    name: "WestWay",
    slug: "westway",
    website: "https://westwaydigital.com/",
    logo: {
      path: "client/westway.svg",
      alt: "WestWay logo",
    },
    relationship: {
      from: null,
...
export const TESTIMONIALS = [
  {
    id: "natasha-shukin-digiproduct-1",
    name: "Natasha Shukin",
    role: "Client",
    company: "Digiproduct",
    companyLink: "http://digiproduct.co.il",
    quote: "Good solid work. Thank you.",
    order: 1,
    isHidden: false,
  },
  {
    id: "dmitri-khanine-ecm-solutions-1",
    name: "Dmitri Khanine",
    role: "Client",
    company: "ECM Solutions",
    companyLink: "http://ecmsolutions.ca/",
    quote:
      "Aleks is an amazing developer. He is talented and dedicated, creates killer UIs, and I will invite him to future UI projects.",
    order: 2,
    isHidden: false,
  },
  {
    id: "thomas-gunther-vienna-1",
    name: "Thomas Gunther",
    role: "Client",
    company: "Viennaresidence",
    companyLink: "https://www.viennaresidence.com/",
    quote:
      "Fast and reliable, but does not tell many jokes. Almost as fast as the websites he makes.",
    order: 3,
    isHidden: false,
  },
  {
    id: "fredrik-kronberg-1",
    name: "Fredrik Kronberg",
    role: "Client",
    company: null,
    companyLink: null,
    quote:
      "Very happy with Oleksandr's work. He has broad frontend and backend knowledge, clear communication, great availability, and I highly recommend him for full stack development, CSS, JS, and more.",
    order: 4,
    isHidden: false,
  },
  {
    id: "fredrik-kronberg-2",
    name: "Fredrik Kronberg",
    role: "Client",
    company: null,
    companyLink: null,
    quote:
      "Very satisfied with Oleksandr and his work. It started as advanced JS/CSS changes and evolved into a small PHP management system, delivered quickly and efficiently. Great communication, availability, and quality.",
    order: 5,
    isHidden: false,
  },
  {
    id: "anonymous-client-1",
    name: "Anonymous Client",
    role: "Client",
    company: null,
    companyLink: null,
    quote:
      "Oleks is a great developer. We spent a couple of days investigating an issue in a new project, and he fixed it in a couple of hours. Great performance. Definitely hiring again.",
    order: 6,
    isHidden: false,
  },
  {
    id: "anonymous-client-2",
    name: "Anonymous Client",
    role: "Client",
    company: null,
    companyLink: null,
    quote:
      "Very talented developer. Started a new website from scratch and I am very happy with his performance and skills.",
    order: 7,
    isHidden: false,
  },
  {
    id: "anonymous-client-3",
    name: "Anonymous Client",
    role: "Client",
    company: null,
    companyLink: null,
